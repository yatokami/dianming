...
class PasswdController extends \Common\Controller\BaseController {
    ...
    public function check() {
    	...
    	$result = M('user')->getFieldById(session('user')['id'],'password');	// 从数据库中查询该学号中的密码
    	// 如果查询结果与传递的原密码md5值一致
